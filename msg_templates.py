...
مثلا 1,2
       ...
       👇 اور اگر آپ تمام اقسام کا انتخاب کرنا چاہتے ہیں تو نیچے دیے گئے آل کا بٹن دبایئں 
        ...
        اُپ کا فری ٹرائل تین دن کے لیے شروع کر دیا گیا ہے۔
        """
...
3️⃣ Services
        ...
        *For Example*: 1,3
        ...
        """
        self.keep_registering = """
        You need to complete your *account setup* before you can start your *Free Trial*🎓 of *3 Days*. 
        You can change your *settings*🔧 anytime.
        """
        self.register_success = """
        Welcome to *TenderWala*
        
        Your *Free Trial for 3 Days* has been *Initiated*
